...
namespace Fingers10.EnterpriseArchitecture.ApplicationCore.Specifications
{
    public abstract class BaseSpecification<T> : ISpecification<T>
    {
        ...
        public Expression<Func<T, bool>> SearchCriteria { get; private set; }
        ...
        protected virtual void ApplySearchCriteria(Expression<Func<T, bool>> searchExpressions)
        {
            SearchCriteria = searchExpressions;
        }
    }
}
